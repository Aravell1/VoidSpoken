...
void ACheckPoints::OnPlayerCollide(UPrimitiveComponent* HitComp, AActor* OtherActor, UPrimitiveComponent* OtherComp,
...
void ACheckPoints::OnSpawnEnemy()
{
	//// Check if ReferenceActor is valid
	//if (ReferenceActor != nullptr)
	//{
	//	// Check if the enemy already exists at the ReferenceActor location
	//	TArray<AActor*> FoundEnemies;
	//	ReferenceActor->GetOverlappingActors(FoundEnemies);
	//	bool bEnemyExists = false;
	//	for (AActor* FoundEnemy : FoundEnemies)
	//	{
	//		if (FoundEnemy->IsA(AActor::StaticClass()))
	//		{
	//			FoundEnemy->Destroy();
	//			break;
	//		}
	//	}
	//	// Spawn the enemy at the ReferenceActor location
	//	UWorld* World = GetWorld();
	//	if (World != nullptr)
	//	{
	//		FActorSpawnParameters SpawnParams;
	//		SpawnParams.SpawnCollisionHandlingOverride = ESpawnActorCollisionHandlingMethod::AlwaysSpawn;
	//		AActor* SpawnedEnemy = World->SpawnActor<AActor>(AActor::StaticClass(), ReferenceActor->GetActorLocation(), ReferenceActor->GetActorRotation(), SpawnParams);
	//	}
	//}
}